...
//    }
    ...
    var model: CategoryModel? {
        didSet {
            ...
            containerView.layer.borderWidth = model.selected ? 0 : 0
            containerView.layer.borderColor = model.selected ? UIColor.white.cgColor : UIColor.clear.cgColor
            selectedBorderView.layer.borderWidth = model.selected ? 3 : 0
            selectedBorderView.layer.borderColor = model.selected ? R.color.meatzBg()?.cgColor : UIColor.clear.cgColor
        }
    }
}
