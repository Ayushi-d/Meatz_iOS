...
class DaysCollectionViewCell: UICollectionViewCell {
    ...
    override var isSelected: Bool {
        didSet {
            ...
            containerView.backgroundColor = isSelected ? R.color.maetzLightRed() : UIColor.white
            
            containerView.BorderC = isSelected ? R.color.maetzLightRed()! : R.color.appGrayColor()!
